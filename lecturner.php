...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="./css/styleLecturner.css">
  ...
  <body style="background-image: url(images/lecturner.jpg);">
    <div class="container-fluid"> 
      <div class="row-fluid"> 
        ...
        <form class="form-horizontal" action="#" method="get" id="login_form"> 
          ...
          <div class="form-group"> 
            <div class="col-md-12 kiki">
              <div>
                <button type="submit" class="btn btn-md btn-danger">Đăng nhập </button> 
              </div>
            </div> 
          </div>
          <div class="card-body">
            <p><b>Đăng nhập bằng tài khoản</b></p>
            <p><b>do P.Hành Chính cung cấp</b></p>
          </div>
          </fieldset> 
        </form> 
        </div> 
